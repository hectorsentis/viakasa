...
export async function up({ db, payload, req }: MigrateUpArgs): Promise<void> {
  ...
  CREATE TYPE "public"."enum_properties_city" AS ENUM('Madrid', 'Tenerife', 'Otra');
  CREATE TYPE "public"."enum_properties_operation" AS ENUM('sale', 'rent', 'sold');
  CREATE TYPE "public"."enum_pages_status" AS ENUM('draft', 'published');
  CREATE TYPE "public"."enum_leads_source" AS ENUM('contact', 'property', 'valuation');
  ...
  CREATE TABLE "properties" (
  	...
  	"city" "enum_properties_city" NOT NULL,
  	"price" numeric,
  	"price_note" varchar,
  	"operation" "enum_properties_operation" DEFAULT 'sale' NOT NULL,
  ...
  CREATE TABLE "services" (
  	...
  	"title" varchar NOT NULL,
  	"description" varchar NOT NULL,
  	"icon" varchar DEFAULT 'home' NOT NULL,
  ...
  CREATE TABLE "site_settings" (
  	"id" serial PRIMARY KEY NOT NULL,
  	"site_name" varchar DEFAULT 'Viakasa' NOT NULL,
  	"tagline" varchar DEFAULT 'La vía directa a tu casa',
  	"hero_title" varchar DEFAULT 'La vía directa a tu casa',
  	"hero_text" varchar DEFAULT 'Asesoría inmobiliaria integral: compra, venta, gestión legal y financiera con un único interlocutor de confianza.',
  	"hero_image_id" integer,
  	"phone" varchar DEFAULT '600 123 450',
  	"email" varchar DEFAULT 'info@viakasa.es',
  	"offices" varchar DEFAULT 'Madrid · Santa Cruz de Tenerife',
  	"footer_text" varchar DEFAULT 'Tu asesoría inmobiliaria de confianza.',
  	"primary_cta" varchar DEFAULT 'Ver propiedades',
  	"secondary_cta" varchar DEFAULT 'Valoración gratuita',
  	"updated_at" timestamp(3) with time zone DEFAULT now() NOT NULL,
  	"created_at" timestamp(3) with time zone DEFAULT now() NOT NULL
  );
  ...
  CREATE TABLE "leads" (
  	...
  	"message" varchar,
  	"property_id" integer,
  	"source" "enum_leads_source" DEFAULT 'contact',
  	"updated_at" timestamp(3) with time zone DEFAULT now() NOT NULL,
  	"created_at" timestamp(3) with time zone DEFAULT now() NOT NULL
  );
  ...
  ALTER TABLE "properties" ADD CONSTRAINT "properties_main_image_id_media_id_fk" FOREIGN KEY ("main_image_id") REFERENCES "public"."media"("id") ON DELETE set null ON UPDATE no action;
  ...
  CREATE INDEX "properties_main_image_idx" ON "properties" USING btree ("main_image_id");
...
export async function down({ db, payload, req }: MigrateDownArgs): Promise<void> {
  ...
  DROP TYPE "public"."enum_properties_city";
  DROP TYPE "public"."enum_properties_operation";
